...
export function createMonthlyPlaylist(spotify_user_id, access_token) {
...
export function createMonthify30Playlist(spotify_user_id, access_token) {
    return __awaiter(this, void 0, void 0, function* () {
        // Create playlist via API call
        yield axios
            .post(`https://api.spotify.com/v1/users/${spotify_user_id}/playlists`, {
...
export function updatePlaylistImage(base64Encoding, playlist_id, access_token) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            // API call to upload playlist image
            yield axios.put(`https://api.spotify.com/v1/playlists/${playlist_id}/images`, base64Encoding, {
                headers: {
                    Authorization: `Bearer ${access_token}`,
            ...
            if (error.response && error.response.status === 503) {
                ...
                // Retry image update
                yield updatePlaylistImage(base64Encoding, playlist_id, access_token);
            }
...
export function getPlaylists(spotify_user_id, access_token) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        while (next) {
            const response = yield axios.get(`${next}`, {
                headers: {
                    Authorization: `Bearer ${access_token}`,
                },
            });
...
export function getTracksFromPlaylist(access_token, playlist_id) {
    return __awaiter(this, void 0, void 0, function* () {
...
function getPotentialTracks(spotify_user_id, access_token) {
    return __awaiter(this, void 0, void 0, function* () {
        // Get user's information
        const user = yield getUserById(spotify_user_id);
        if (user) {
            ...
            const likedSongs = yield getLikedSongs(access_token, spotify_user_id);
...
export function updateMonthifyPlaylists(spotify_user_id, access_token, is_new_month) {
    return __awaiter(this, void 0, void 0, function* () {
        // If it's a new month
        if (is_new_month) {
            ...
            yield createMonthlyPlaylist(spotify_user_id, access_token);
        }
        // Get potential songs for montly playlist and Monthify 30 playlist
        const potentialTracks = yield getPotentialTracks(spotify_user_id, access_token);
...
export function getLikedSongs(access_token, spotify_user_id) {
    return __awaiter(this, void 0, void 0, function* () {
