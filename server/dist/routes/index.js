...
export function createServerRoutes(app) {
    ...
    app.get('/callback', async (req, res) => {
        try {
            ...
            const { refresh_token, access_token, token_type } = tokenResponse.data;
            // Fetch current user's information
            console.log('Fetching user spotify profile data');
            const spotifyProfileResponse = await axios.get('https://api.spotify.com/v1/me', {
                headers: {
            ...
            if (existingUser) {
                ...
                await createUser(spotify_display_name, spotify_user_id, refresh_token);
